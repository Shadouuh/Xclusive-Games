    ...
    <>
      <div className="games-container">
        <div className="game-sidebar">
          ...
          <div className="filter-section">
            <h1 className="filter-title-text"> <LuJoystick/>  Generos</h1>
            <div className="filter-containers">
              <p className="filter-text">RPG</p>
              <p className="filter-text">Indie</p>
              <p className="filter-text">Rogue-Like</p>
              <p className="filter-text">Aventura</p>
              <p className="filter-text">Guerra</p>
            </div>
          </div>
        </div>
        <div className="games-content">
          <h1 className="games-title-text" id="color">
            Explora nuestro Juegos
          </h1>
